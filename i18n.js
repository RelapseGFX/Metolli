...
const T = {
  en: {
    ...
    'svc.emergency'       : '24/7 Emergency Service',
    'svc.pipe'            : 'Pipe Installation',
    'svc.waterheater'     : 'Water Heater Service',
    'svc.drain'           : 'Drain Cleaning',
    'svc.desc.heating'    : 'Modern heating systems professionally installed and maintained for efficient, reliable warmth in your home or business.',
    'svc.desc.sanitary'   : 'Complete sanitary installations handled with precision, from pipework routing to final fixture fitting.',
    'svc.desc.solar'      : 'Harness the sun with professionally installed solar thermal systems that cut energy costs and reduce your carbon footprint.',
    'svc.desc.renewable'  : 'Future-proof your property with clean energy solutions tailored to your needs, planned and installed from start to finish.',
    'svc.desc.bathroom'   : 'Transform your bathroom into a modern retreat. We manage everything from layout planning to the final fitting.',
    'svc.desc.aircon'     : 'Stay comfortable year-round with energy-efficient climate control systems professionally sized and installed for your space.',
    'svc.desc.chimney'    : 'Safe, clean, and up to current standards. We restore and renovate chimneys with lasting results.',
    'svc.desc.stoves'     : 'Custom-built stoves that combine warmth and character. We craft and install both traditional and modern stove solutions.',
    'svc.desc.emergency'  : 'Burst pipe or heating failure at midnight? We are on call around the clock to respond to any urgent situation fast.',
    'svc.desc.pipe'       : 'Reliable pipe installations for new builds and renovations. Clean, professional work engineered to last.',
    'svc.desc.waterheater': 'Installation, maintenance, and repair of all water heater types so you always have hot water when you need it.',
    'svc.desc.drain'      : 'Blocked drains cleared quickly and thoroughly using professional tools to restore full flow to your system.',
    ...
    'form.opt.emergency'  : '24/7 Emergency Service',
    'form.opt.pipe'       : 'Pipe Installation',
    'form.opt.waterheater': 'Water Heater Service',
    'form.opt.drain'      : 'Drain Cleaning',
  ...
  de: {
    ...
    'svc.stoves'          : 'Ofenbau',
    'svc.emergency'       : '24/7 Notdienst',
    'svc.pipe'            : 'Rohrinstallation',
    'svc.waterheater'     : 'Warmwasserservice',
    'svc.drain'           : 'Rohrreinigung',
    'svc.desc.heating'    : 'Moderne Heizungsanlagen professionell installiert und gewartet für effiziente, zuverlässige Wärme in Ihrem Zuhause oder Betrieb.',
    'svc.desc.sanitary'   : 'Komplette Sanitärinstallationen präzise ausgeführt, von der Rohrführung bis zur abschließenden Armaturenmontage.',
    'svc.desc.solar'      : 'Nutzen Sie die Kraft der Sonne mit professionell installierten Solarthermieanlagen, die Energiekosten senken und Ihren CO₂-Fußabdruck reduzieren.',
    'svc.desc.renewable'  : 'Machen Sie Ihr Gebäude zukunftssicher mit nachhaltigen Energielösungen, individuell geplant und von Anfang bis Ende installiert.',
    'svc.desc.bathroom'   : 'Verwandeln Sie Ihr Badezimmer in ein modernes Rückzugsort. Wir übernehmen alles von der Planung bis zur letzten Montage.',
    'svc.desc.aircon'     : 'Bleiben Sie das ganze Jahr über komfortabel mit energieeffizienten Klimaanlagen, professionell dimensioniert und für Ihren Raum installiert.',
    'svc.desc.chimney'    : 'Sicher, sauber und nach aktuellem Standard. Wir sanieren und renovieren Kamine mit dauerhaften Ergebnissen.',
    'svc.desc.stoves'     : 'Maßgefertigte Öfen, die Wärme und Charakter vereinen. Wir bauen und installieren traditionelle und moderne Ofenlösungen.',
    'svc.desc.emergency'  : 'Rohrbruch oder Heizungsausfall um Mitternacht? Wir sind rund um die Uhr erreichbar, um in jeder Notlage schnell zu helfen.',
    'svc.desc.pipe'       : 'Zuverlässige Rohrinstallationen für Neubauten und Renovierungen. Saubere, professionelle Arbeit, die hält.',
    'svc.desc.waterheater': 'Installation, Wartung und Reparatur aller Warmwassergeräte, damit Sie immer warmes Wasser haben, wenn Sie es brauchen.',
    'svc.desc.drain'      : 'Verstopfte Abflüsse schnell und gründlich beseitigt. Wir setzen professionelles Werkzeug ein, um Ihr System wieder freizuspülen.',
    ...
    'form.opt.emergency'  : '24/7 Notdienst',
    'form.opt.pipe'       : 'Rohrinstallation',
    'form.opt.waterheater': 'Warmwasserservice',
    'form.opt.drain'      : 'Rohrreinigung',
...
const BINDINGS = [
  ...
  ['.service-card:nth-child(9) .svc-body h3',   't', 'svc.emergency'],
  ['.service-card:nth-child(10) .svc-body h3',  't', 'svc.pipe'],
  ['.service-card:nth-child(11) .svc-body h3',  't', 'svc.waterheater'],
  ['.service-card:nth-child(12) .svc-body h3',  't', 'svc.drain'],
  ['.service-card:nth-child(1) .svc-body p',    't', 'svc.desc.heating'],
  ['.service-card:nth-child(2) .svc-body p',    't', 'svc.desc.sanitary'],
  ['.service-card:nth-child(3) .svc-body p',    't', 'svc.desc.solar'],
  ['.service-card:nth-child(4) .svc-body p',    't', 'svc.desc.renewable'],
  ['.service-card:nth-child(5) .svc-body p',    't', 'svc.desc.bathroom'],
  ['.service-card:nth-child(6) .svc-body p',    't', 'svc.desc.aircon'],
  ['.service-card:nth-child(7) .svc-body p',    't', 'svc.desc.chimney'],
  ['.service-card:nth-child(8) .svc-body p',    't', 'svc.desc.stoves'],
  ['.service-card:nth-child(9) .svc-body p',    't', 'svc.desc.emergency'],
  ['.service-card:nth-child(10) .svc-body p',   't', 'svc.desc.pipe'],
  ['.service-card:nth-child(11) .svc-body p',   't', 'svc.desc.waterheater'],
  ['.service-card:nth-child(12) .svc-body p',   't', 'svc.desc.drain'],
  ...
  ['.service-card:nth-child(9) .svc-link',      't', 'svc.link'],
  ['.service-card:nth-child(10) .svc-link',     't', 'svc.link'],
  ['.service-card:nth-child(11) .svc-link',     't', 'svc.link'],
  ['.service-card:nth-child(12) .svc-link',     't', 'svc.link'],
  ...
  ['#cf-service option:nth-child(10)',           't', 'form.opt.emergency'],
  ['#cf-service option:nth-child(11)',           't', 'form.opt.pipe'],
  ['#cf-service option:nth-child(12)',           't', 'form.opt.waterheater'],
  ['#cf-service option:nth-child(13)',           't', 'form.opt.drain'],
  ...
  ['#mf-service option:nth-child(10)',          't', 'form.opt.emergency'],
  ['#mf-service option:nth-child(11)',          't', 'form.opt.pipe'],
  ['#mf-service option:nth-child(12)',          't', 'form.opt.waterheater'],
  ['#mf-service option:nth-child(13)',          't', 'form.opt.drain'],
